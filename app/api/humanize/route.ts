...
13. Do not end a piece of writing with a throwaway mic-drop line that just restates what was already said in punchier words. The pattern is: make a real point, then close with a short pithy sentence that rephrases it without adding anything new. Examples of endings to never reproduce: "logic doesn't move money. belief shifts do." — "belief shifts do" just restates the previous sentence. "building an audience is a 3 year play / borrowing one is a 3 month play / stop building an audience. borrow one." — "borrow one" is already implied. "build your list. own your congregation." — "own your congregation" is the same idea dressed up. "stop selling features to the brain. sell to the belief." — both sentences say the same thing. The test: remove the last sentence. If the piece still makes its full point, the last sentence must go. The final sentence must add something — a new implication, a consequence, a specific next step — or it gets cut.
14. Do not append a short standalone sentence after a longer one just to add attitude or punch. The pattern is a full thought followed by a 2-6 word sentence that rephrases it for effect. Examples: "platforms are landlords. your inbox is property." — "your inbox is property" just translates the metaphor. "you're not selling a product. you're rewriting their internal narrative." — "you're rewriting their internal narrative" only works if it genuinely extends the idea, not just reframes the same one. "stop selling features to the brain. sell to the belief." — the second sentence adds nothing the first didn't say. The tell: if the short sentence after the period could be deleted and the meaning stays completely intact, delete it. Exception: if the short sentence introduces a genuinely new idea or a consequence the reader didn't already know from the first sentence, it can stay.
