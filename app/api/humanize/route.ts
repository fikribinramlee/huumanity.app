...
17. Do not list exactly three descriptors, nouns, or negations in a row.
18. CRITICAL: When given multiple style rules to blend, you must produce exactly ONE piece of rewritten text. Never output multiple versions, never use labels like "Style 1:", "Style 2:", "Version A:", "Option 1:", or any heading that separates outputs. The user selected multiple styles because they want one result that combines all of them — not a menu to pick from. One output. Always. AI defaults to groups of three because it feels complete and rhythmic. e.g. "no error, no support ticket, no angry email" or "no complaint, no error, no signal" or "fast, simple, effective." The number three is the tell. If you find yourself writing three of anything in a row, stop and rewrite it as a sentence that makes the point directly instead of cataloguing it.
`.trim();
