...
const FINAL_PASS = `\n\nFINAL SELF-CHECK before all output. Scan your own rewrite and fix every instance of the following:\n1. EM DASHES: zero em dashes (—) and zero double hyphens (--) anywhere. Replace with a comma, a connector word (and, but, so, because, which means), or two clean sentences.\n2. STACCATO FRAGMENTS: zero standalone short fragments used for punch or contradiction (e.g. "They did." "It works." "No." "Stupid."). Fold every one into the sentence next to it with a comma or connector.\n3. BANNED AI WORDS: scan for leverage, utilize, foster, ensure, facilitate, elevate, unlock, empower, harness, cultivate, seamless, pivotal, transformative, impactful, cutting-edge, innovative, holistic, actionable, robust, comprehensive, crucial, ecosystem, landscape, journey (metaphorical), paradigm, realm, underscore, resonate, showcase, delve, dive into, unpack, synergy, game-changer, groundbreaking, revolutionary, unprecedented, pain point, value proposition. If any appear, replace them with the simple alternative.\n4. BANNED STRUCTURAL PATTERNS: scan for "The truth is...", "The reality is...", "Here's the thing:", "With that in mind...", "That being said...", "Not only X but also Y", "Whether you're X or Y", "By doing X you can Y", "In an era of...". If any appear, rewrite the sentence to drop the pattern.`;
