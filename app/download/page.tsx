...
const RELEASES_BASE =
  "https://github.com/fikribinramlee/huumanity.app/releases/download/v0.3.4";
const MAC_URL = `${RELEASES_BASE}/huumanity_0.3.4_aarch64.dmg`;
const WIN_URL = `${RELEASES_BASE}/huumanity_0.3.4_x64-setup.exe`;
