...
const RELEASES_BASE =
  "https://github.com/fikribinramlee/huumanity.app/releases/download/v0.3.3";
const MAC_URL = `${RELEASES_BASE}/huumanity_0.3.3_aarch64.dmg`;
const WIN_URL = `${RELEASES_BASE}/huumanity_0.3.3_x64-setup.exe`;
