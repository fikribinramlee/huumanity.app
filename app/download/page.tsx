...
const RELEASES_BASE =
  "https://github.com/fikribinramlee/huumanity.app/releases/download/v0.3.5";
const MAC_URL = `${RELEASES_BASE}/huumanity_0.3.5_aarch64.dmg`;
const WIN_URL = `${RELEASES_BASE}/huumanity_0.3.5_x64-setup.exe`;
