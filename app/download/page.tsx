...
const RELEASES_BASE =
  "https://github.com/fikribinramlee/huumanity.app/releases/download/v0.2.8";
const MAC_URL = `${RELEASES_BASE}/huumanity_0.2.8_aarch64.dmg`;
const WIN_URL = `${RELEASES_BASE}/huumanity_0.2.8_x64-setup.exe`;
